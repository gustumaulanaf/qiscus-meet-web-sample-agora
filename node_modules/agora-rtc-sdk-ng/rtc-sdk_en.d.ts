...
export declare interface CameraVideoTrackInitConfig {
    ...
    cameraId?: string;
    /**
     * Whether to prioritize video quality or smoothness:
...
export declare interface ClientConfig {
     ...
     *
     * If [mode]{@link ClientConfig.mode} is set as `live`, use this property to set the user role. The default role is `host`.
     *
 ...
 * - `LIVE_STREAMING_TASK_CONFLICT`: The CDN live streaming task exists.
...
export declare interface IAgoraRTC {
     ...
     * @param withAudio Whether to share the audio of the audio output device when sharing the screen.
     ...
     * > Note:
     * > - This function is only supported on Chrome 74 or later on Windows.
     ...
     * };
     * ```
     * @param deviceInfo deviceInfo: Information of the video capture device. See {@link DeviceInfo}.
 ...
 *
 * ```javascript
 * const configuration = new AgoraRTC.ChannelMediaRelayConfiguration();
...
export declare interface LiveStreamingTranscodingConfig {
     ...
     */
    images?: LiveStreamingTranscodingWaterMark[];
    /**
 ...
 */
export declare interface LiveStreamingTranscodingWaterMark {
    /**
    ...
    height?: number;
    /**
     * The layer index of the watermark image.
     *
     * An integer. The value range is [0,100].
     *
     * - 0: (Default) Bottom layer.
